 ...
 *
 * Lucide dropped third-party brand marks, so the one brand mark this site shows
 * is inlined here rather than pulled from a second icon package for a single
 * glyph. Drawn with `currentColor` so it inherits whatever the button around it
 * is set to and follows the colour scheme with no extra wiring.
 */
